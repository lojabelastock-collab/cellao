<?php
/**
 * Atualiza o Controller REST API principal.
 *
...
class SMM_REST_Controller {
	...
	public function register_routes() {
		...
		require_once SMM_PLUGIN_DIR . 'api/class-smm-rest-providers-controller.php';
		$providers_controller = new SMM_REST_Providers_Controller();
		$providers_controller->register_routes();

		// Registrar sync controller.
		require_once SMM_PLUGIN_DIR . 'api/class-smm-rest-sync-controller.php';
		$sync_controller = new SMM_REST_Sync_Controller();
